...
if ($email != "") {
  ...
  <body>
    ...
    <div class="container-fluid px-0" style="padding: 67px 0 5rem 0;">
      ...
      </div><div class="row g-0 justify-content-center align-items-center">
        <div class="col-10">
          <?php 
          ...
          if ($level=="admin" || $level=="promotor") {
            ...
            <table>
              ...
              <?php 
              $query1 = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE status = 'pending' AND depo_wd = 'Withdraw' ");
              $no = 1;
              while ($data = mysqli_fetch_array($query1)) {
                ...
                <tr>
                  ...
                  <td style="width: 258px;">
                    <a href="function/konfirmasi_withdraw.php?id=<?php echo $data['id'] ?>&email=<?php echo $data['email'] ?>" class="btn btn-primary">Acc Withdraw</a>
                    <a href="edit_withdraw.php?id=<?php echo $data['id'] ?>&email=<?php echo $data['email'] ?>" class="btn btn-warning">Edit</a>
                    <a href="function/konfirmasi_withdraw_hapus.php?id=<?php echo $data['id'] ?>&email=<?php echo $data['email'] ?>" class="btn btn-danger">Hapus</a>
                  </td>
                </tr>
                <?php
              }
            ...
            <div class="row col-md-12">
              <form action="function/aksi_withdraw.php" method="POST">
                <div class="form-group">
                  ...
                  <p style="font-style: italic; color: red">*Minimal Withdraw Rp. 50.000</p>
                </div>
                <div class="form-group">
                  <h4>Tujuan : </h4>
                  <select class="form-control" name="bank" required="">
                    ...
                    <?php 
                    $query2 = mysqli_query($koneksi, "SELECT pembayaran, no_rekening, nama_rekening FROM user WHERE email = '$email' ");
                    while ($data1 = mysqli_fetch_array($query2)) {
                      ?>

                      <option value="<?php echo $data1['pembayaran'] ?> - <?php echo $data1['no_rekening'] ?> - <?php echo $data1['nama_rekening'] ?>">
                        <?php echo $data1['pembayaran'] ?> - <?php echo $data1['no_rekening'] ?> - <?php echo $data1['nama_rekening'] ?>
                      </option>
                      <?php
                    }
                    ?>
            ...
            <table>
              ...
              <?php 
              $query1 = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE email = '$email' AND depo_wd = 'Withdraw' ORDER BY id DESC ");
              $no = 1;
              while ($data = mysqli_fetch_array($query1)) {
                ?>
                <tr>
