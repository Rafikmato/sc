      ...
      <div class="row g-0 justify-content-center align-items-center">
        <div class="col-10">
          ...
          <nav class="nav nav-pills nav-justified">
            ...
            <a class="nav-link active" aria-current="page" href="ubah_password.php">Ubah Password</a>
            <a class="nav-link" aria-current="page" href="bank.php">Data Bank</a>
          </nav>
          <br>
          <div class="row col-md-12">
            ...
            <form action="function/aksi_ubah_password.php" method="POST">
              <div class="form-group">
                <h4>Password Lama Anda : </h4>
