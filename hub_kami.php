...
<body>
  ...
  <div class="container-fluid px-0" style="padding: 67px 0 5rem 0;">
    ...
    <div class="row g-0 justify-content-center align-items-center">
      <div class="col-10">
        <div class="hub-kami">
          <a href="<?php echo $live_chat ?>" target="_blank" style="background-image: url(admin/assets/images/8874476111_2058667409_2172874817_live-chat.svg);">
          ...
          <a href="https://wa.me/<?php echo $live_chat_wa ?>?text=Hai <?php echo $nama_website ?> slot👋" style="background-image: url(admin/assets/images/8684255092_whatsapp.svg);">
            <h3><?php echo $live_chat_wa; ?></h3>
            <h6>
              klik disini
              <i class="ri-arrow-right-s-line"></i>
            </h6>
                ...
                <div class="row g-2">
                  ...
                  <div class="col">
                    <a href="hub_kami.php" class="d-flex flex-column align-items-center text-decoration-none">
                      ...
                      <img src="admin/assets/images/svg/live-chat-active.svg" alt="Home" width="25" height="25">
