  ...
  <body>
    ...
    <div class="container-fluid px-0" style="padding: 67px 0 5rem 0;">
      ...
      <?php
        if ($provider == "pragmaticplay") {
              ?>
                ...
                <h1>Provider : <img src="https://img.pay4d.info/slot-prag.png" width="80px"> Pragmatic Play  </h1>
              ...
              ?>
                ...
                <h1>Provider : <img src="https://img.pay4d.info/slot-pg.png" width="80px"> PG SOFT  </h1>
              <?php
            }else{
                include 'index.php';
            }
      ...
      <div class="row g-3 justify-content-center align-items-center">
        <?php 
        $query = mysqli_query($koneksi, "SELECT * FROM game WHERE provider = '$provider' ");
              ...
              while ($data1 = mysqli_fetch_array($query1)) {
                if ($data1['saldo'] == 0) {
                  ...
                  <div class="card" style="width: 100%">
                    ...
                    <a href="main/main.php?id=<?php echo $data['id'] ?>&provider=<?php echo $provider ?>" target="_blank">
                      <img class="card-img-top" src="admin/assets/images/slot/<?php echo $data['gambar'] ?>" alt="Card image cap">
