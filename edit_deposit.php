        ...
        <div class="col-10">
          ...
          if ($level=="admin" || $level=="promotor") {
            ...
            if (isset($_GET['id']) && isset($_GET['email'])) {
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE email = '$email' AND id = '$id' AND depo_wd = 'Deposit' ");
            ...
            <form action="function/aksi_ubah_deposit.php" method="POST">
              ...
              <br>
              <div class="form-group">
                <input type="submit" name="submit" class="btn btn-warning" style="float: right;" value="Ubah Data Deposit">
              </div>
            </form>
            <?php
          }else{
