      ...
      <div class="row g-0 justify-content-center align-items-center">
        <div class="col-10">
          ...
          <div class="row col-md-12">
            ...
            <form action="function/ubah_tujuan_deposit.php" method="POST">
          ...
          <table>
              ...
              <?php 
              $query1 = mysqli_query($koneksi, "SELECT * FROM bank ");
              $no = 1;
              while ($data = mysqli_fetch_array($query1)) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="edit_tujuan_deposit.php?id=<?php echo $data['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                    <a href="function/hapus_tujuan_deposit.php?id=<?php echo $data['id'] ?>" class="btn btn-sm btn-danger">Hapus</a>
                  </td>
