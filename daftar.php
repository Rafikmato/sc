...
if ($email == "") {
  ...
  <body>
   ...
   <div class="container-fluid px-0" style="padding: 67px 0 5rem 0;">
    ...
    <form method="POST" action="function/aksi_daftar.php">
      <div class="row gy-3 gx-0 justify-content-center align-items-center my-5">
        ...
        <div class="col-10 px-4">
          <div class="mb-3">
            ...
            <input type="text" name="nama_pengguna_akun" class="form-control form-control-sm rounded-0" placeholder="Nama Pengguna Anda" required>
          </div>
          <div class="mb-3">
        ...
        <div class="col-10 px-4">
          ...
          <div class="text-center">
            Dengan meng-klik tombol DAFTAR, saya menyatakan bahwa saya berumur diatas 18 tahun dan telah membaca dan menyetujui syarat & ketentuan.
          </div>
        </div>
      </div>
    </form>    
