      ...
      <div class="row g-0 justify-content-center align-items-center">
        <div class="col-10">
          ...
          <nav class="nav nav-pills nav-justified">
            <a class="nav-link" href="profil.php">Profil Akun</a>
            <a class="nav-link " aria-current="page" href="ubah_password.php">Ubah Password</a>
            <a class="nav-link active" aria-current="page" href="bank.php">Data Bank</a>
          </nav>
          <br>
          <div class="row col-md-12">
            ...
            <form action="function/aksi_ubah_bank.php" method="POST">
              <div class="form-group">
                <h4>Bank : </h4>
                <input type="hidden" name="id" value="<?php echo $id ?>">
                <input type="hidden" name="email" value="<?php echo $email ?>">
                <input type="text" class="form-control" name="bank" required="" value="<?php echo $pembayaran ?>">
              </div>
              <br>
              <div class="form-group">
                <h4>No Rekening : </h4>
                <input type="text" value="<?php echo $no_rekening ?>" class="form-control" name="no_rekening" required="">
              </div>
              <br>
              <div class="form-group">
                <h4>Nama Rekening : </h4>
                <input type="text" class="form-control" name="nama_rekening" value="<?php echo $nama_rekening ?>" required="">
              </div>
              <br>
              <div class="form-group">
                <input type="submit" name="submit" class="btn btn-warning" style="float: right;" value="Ubah Password">
              </div>
            </form>
          </div>
          <br>
