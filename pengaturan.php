      ...
      <div class="row g-0 justify-content-center align-items-center">
        <div class="col-10">
          ...
          <nav class="nav nav-pills nav-justified">
            <a class="nav-link active" aria-current="page" href="pengaturan.php">Dasar</a>
          ...
          <div class="row col-md-12">
            ...
            <form action="function/ubah_pengaturan.php" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                <h4>Nama Website : </h4>
                <input type="hidden" name="id" value="<?php echo $id ?>">
                <input type="hidden" name="level" value="<?php echo $level ?>">
                <input type="hidden" name="nama_pengguna" value="<?php echo $nama_pengguna ?>">
                <input type="text" class="form-control" name="nama_website" required="" value="<?php echo $nama_website ?>">
              </div>
              <br>
              <div class="form-group">
                <h4>Logo : </h4>
                <img src="admin/assets/images/<?php echo $logo ?>" width="500px" class="img-fluid">
                <input type="file" class="form-control" name="file" >
                <p style="color: red; font-style: italic; font-size: 20px">*Abaikan Jika Tidak Ingin Mengubah Logo</p>
              </div>
              <br>
              <div class="form-group">
