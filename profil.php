      ...
      <div class="row g-0 justify-content-center align-items-center">
        <div class="col-10">
          ...
          <nav class="nav nav-pills nav-justified">
            <a class="nav-link active" aria-current="page" href="profil.php">Profil Akun</a>
            <a class="nav-link" href="ubah_password.php">Ubah Password</a>
            <a class="nav-link" href="bank.php">Data Bank</a>
          </nav>
          <br>
          <div class="row col-md-12">
            ...
            <form action="function/aksi_ubah_profil.php" method="POST">
              <div class="form-group">
                <h4>Nama Lengkap : </h4>
                <input type="hidden" name="id" value="<?php echo $id ?>">
                <input type="hidden" name="level" value="<?php echo $level ?>">
                <input type="hidden" name="nama_pengguna" value="<?php echo $nama_pengguna ?>">
                <input type="text" class="form-control" name="nama_pengguna" required="" value="<?php echo $nama_lengkap ?>">
              </div>
              <br>
              <div class="form-group">
                <h4>Email : </h4>
              ...
              <div class="form-group">
                <h4>No. Kontak : </h4>
                <input type="number" class="form-control" name="no_kontak" required="" value="<?php echo $no_kontak ?>">
              </div>
              <br>
              <div class="form-group">
                <h4>No. Whatsapp : </h4>
                <input type="number" class="form-control" name="no_whatsapp" required="" value="<?php echo $no_whatsapp ?>">
              </div>
              <br>
              <div class="form-group">
                <input type="submit" name="submit" class="btn btn-warning" style="float: right;" value="Simpan Data Profil Saya">
              </div>
            </form>
          </div>
          <br>
