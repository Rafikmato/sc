...
if ($email != "" OR $level == "admin") {
  ...
  <head>
    ...
    <title>MANGGA138 - Situs slot online resmi terpercaya di indonesia</title>
    ...
    <div class="fixed-top">
      <div class="container-fluid bg-utama position-relative p-3">
        ...
        <a href="index.php" class="d-block">
          <img src="admin/assets/images/logo.png" alt="Logo" height="35" class="d-block mx-auto">
        </a>
        <?php 
        if ($email == "") {
          ?>
      ...
      <div class="offcanvas offcanvas-end text-bg-dark w-75" data-bs-backdrop="static" tabindex="-1" id="menunya" aria-labelledby="menunyaLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="menunyaLabel">
            <img src="admin/assets/images/logo.png" alt="Logo" height="35">
          </h5>
      ...
      <div class="row g-0 justify-content-center align-items-center">
        <div class="col-10">
          ...
          <nav class="nav nav-pills nav-justified">
            <a class="nav-link" aria-current="page" href="pengaturan.php">Dasar</a>
            <a class="nav-link active" href="tujuan_deposit.php">Tujuan Deposit</a>
          </nav>
          <br>
          <div class="row col-md-12">

            <?php 
            $query = mysqli_query($koneksi, "SELECT * FROM bank WHERE id = '$id' ");
            ...
            <form action="function/ubahh_tujuan_deposit.php" method="POST">
              <div class="form-group">
                <h4>Nama Rekening : </h4>
                <input type="hidden" name="id" value="<?php echo $id ?>">
                <input type="hidden" name="level" value="<?php echo $level ?>">
                <input type="hidden" name="nama_pengguna" value="<?php echo $nama_pengguna ?>">
                <input type="text" class="form-control" name="nama_rekening" required="" value="<?php echo $nama_rekening ?>">
              </div>
              <br>
              <div class="form-group">
                <input type="submit" name="submit" class="btn btn-warning" style="float: right;" value="Simpan Data Pengaturan Website">
              </div>
            </form>
          </div>
          <br>
      ...
      <div class="row g-0 justify-content-center align-items-center mt-3">
        <div class="col-10">
          <div class="text-center">
            <u class="d-block" style="text-align: left;"><span style="background-color: var(--vz-card-bg); text-align: var(--vz-body-text-align); font-size: 36px;"><font color="#ffff00" face="Poppins"><b>MANGGA138</b></font></span><font color="#ffff00" style="font-size: 36px;"><b><span style="font-family: Poppins;">&nbsp;situs Slot online &amp; Judi bola Terlengkap</span></b></font></u>
            <p style="text-align: left;"><b style="font-size: 14.4px;">MANGGA138 situs slot&nbsp;terlengkap</b><span style="font-size: 14.4px;"> dengan RTP tinggi 97% Kemenangan. MANGGA138 kini menjadi salah satu pilihan bermain judi online paling dipercaya dan juga paling lengkap tahun 2021 sampai 2023.&nbsp;</span><span style="font-size: 14.4px;">MANGGA138</span><span style="font-size: 14.4px;">&nbsp;menyediakan permainan slot online,togel online,live casino,poker online,sabung ayam sampai pancing ikan.
            </span></p>
            <u class="d-block" style="text-align: left;"><font color="#ffff00" style=""><span style="font-size: 36px;">MENGAPA MANGGA138</span></font><font color="#ffff00" style=""><span style="font-size: 36px;">&nbsp;MENJADI PILIHAN SEBAGAI WEBSITE SLOT ONLINE PALING POPULER</span></font></u>
            <p style="text-align: left; font-size: 14.4px;"><span style="background-color: var(--vz-card-bg); color: var(--vz-card-color); font-family: var(--vz-body-font-family); font-weight: var(--vz-body-font-weight); text-align: var(--vz-body-text-align);">MANGGA138</span>&nbsp;memiliki banyak hal yang membuat website ini menjadi salah satu tempat bermain paling populer dikalangan remaja sampai dengan orang tua.Salah satunya permainan slot online yang sangat mudah dimainkan dan dimenangkan.Dengan <strong><a href="#" class="text-decoration-none" style="color: #FFFF00;">RTP live tinggi</a></strong> 97% MANGGA138&nbsp;memberikan kemudahan MAXWIN.Dengan modal 10 ribu rupiah kita bisa memainkan slot online dan memenangkan JACKPOT sampai dengan ratusan juta hanya dengan satu kali spin.Permainan slot juga sangat mudah dan asyik untuk dimainkan karena dilengkapi dengan tampilan grafis terbaik.
            </p>
            ...
            <p style="font-size: 14.4px;">
              ...
              <ol>
                ...
                <ol>
                  ...
                  <u class="d-block" style="text-align: left; font-size: 36px; font-weight: 500; color: rgb(255, 0, 0);">Alasan Mengapa harus memilih MANGGA138</u>
                  <p style="text-align: left; font-size: 14.4px;">
                    Mengapa memilih MANGGA138&nbsp;sebagai tempat bermain judi ? Jawabanya karena aman cepat mudah dan nyaman.Dengan mendaftar di MANGGA138&nbsp;kita bisa mendapatkan semua aspek yang kita butuhkan mulai dari data yang aman,cepat dalam hal pelayanan,mudah dalam bermain dan melakukan deposit sampai nyaman karena sering diberi jackpot.Alasan lainnya memiliki MANGGA138&nbsp;sebagai <strong><a href="#" class="text-decoration-none" style="color: #FFFF00;">situs judi online</a></strong> adalah kelengkapan game yang bisa kita mainkan mulai dari game populer slot online,game poker online,domino qiu qiu,live casino,judi taruhan bola online, togel online,mancing ikan bisa kita mainkan dalam satu website saja.
                  </p>
