...
<head>
  ...
  <style>
    ...
    .container-masuk-daftar a.daftar {
      background: url(admin/assets/images/9426195915_tombol-masuk.png);
      background-size: 100% 100%;
      color: #ffffff;
    }
    .sidebar-masuk {
...
<body>
  ...
  <div class="container-fluid px-0" style="padding: 67px 0 5rem 0;">
    ...
    </div><div class="row gy-5 gx-0 justify-content-center align-items-center">
      <div class="col-10">
        <img src="admin/assets/images/promosi/5005235839_mg-playboyclub-june-mobile.gif" alt=" " class="w-100 h-auto mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <span style="font-size: 14px; font-weight: 700;"> </span>
          <button type="button" class="btn btn-danger text-dark" id="promosi_11" style="font-size: 10px;">Klik untuk info lebih lanjut</button>
        </div>
        <div id="expand_promosi_11">
          <p>&nbsp;</p>    </div>
        </div>
        <div class="col-10">
          <img src="admin/assets/images/promosi/8974065534_2024287140_pp-exclusive-robber-strike-mobile.png" alt=" " class="w-100 h-auto mb-3">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <span style="font-size: 14px; font-weight: 700;"> </span>
            <button type="button" class="btn btn-danger text-dark" id="promosi_5" style="font-size: 10px;">Klik untuk info lebih lanjut</button>
          </div>
          <div id="expand_promosi_5">
            <h2 style="margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 30px; color: rgb(255, 255, 255); font-family: digital_sans_ef_medium; text-align: center;">BONUS NEW MEMBER SLOTS 200%</h2><div class="expiration-countdown-container" style="display: flex; justify-content: center; padding: 10px 0px; color: rgb(255, 255, 255); font-family: digital_sans_ef_medium; font-size: 14px;"><div class="expiration-countdown expiration_countdown" data-expiration-date="02-Aug-2024 12:00:00 AM" style="font-family: BebasNeueRegular; display: inline-flex; flex-wrap: nowrap;"><div data-section="title" style="display: flex; flex-direction: column; place-content: center; padding: 5px 10px; text-align: center; background-color: rgb(85, 85, 85); border-left: none rgb(107, 107, 107); min-width: 50px;">BERAKHIR PADA</div><div data-section="days" style="display: flex; flex-direction: column; place-content: center; padding: 5px 10px; text-align: center; background-color: rgb(64, 64, 64); color: rgb(226, 195, 96); border-left: 1px solid rgb(107, 107, 107); min-width: 50px;"><div data-value="days" style="font-size: 18px;">416</div>HARI</div><div data-section="hours" style="display: flex; flex-direction: column; place-content: center; padding: 5px 10px; text-align: center; background-color: rgb(64, 64, 64); color: rgb(226, 195, 96); border-left: 1px solid rgb(107, 107, 107); min-width: 50px;"><div data-value="hours" style="font-size: 18px;">02</div>JAM</div><div data-section="minutes" style="display: flex; flex-direction: column; place-content: center; padding: 5px 10px; text-align: center; background-color: rgb(64, 64, 64); color: rgb(226, 195, 96); border-left: 1px solid rgb(107, 107, 107); min-width: 50px;"><div data-value="minutes" style="font-size: 18px;">29</div>MENIT</div><div data-section="seconds" style="display: flex; flex-direction: column; place-content: center; padding: 5px 10px; text-align: center; background-color: rgb(64, 64, 64); color: rgb(226, 195, 96); border-left: 1px solid rgb(107, 107, 107); min-width: 50px;"><div data-value="seconds" style="font-size: 18px;">30</div>DETIK</div></div></div><div style="font-family: digital_sans_ef_medium; font-size: 14px; color: rgb(85, 85, 85);"><table border="1" style="border-spacing: 0px; max-width: 100%; background-color: red; height: 18px; width: 248px; border-style: solid;"><tbody><tr style="height: 18px;"><td style="width: 247px; text-align: center; height: 18px;"><span style="color: rgb(255, 255, 0);"><span style="font-weight: 600;">BONUS NEWMEMBER SLOT 200%</span></span></td></tr></tbody></table><table border="1" style="border-spacing: 0px; max-width: 100%; background-color: transparent; height: 36px; width: 248px; border-color: red; border-style: solid;"><tbody><tr style="height: 18px;"><td style="width: 58.4479px; height: 18px; text-align: center;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">PRODUK</span></span></td><td style="width: 59.25px; height: 18px; text-align: center;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">MIN DEPOSIT</span></span></td><td style="width: 71.6562px; height: 18px; text-align: center;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">MAX BONUS</span></span></td><td style="width: 57.6458px; height: 18px; text-align: center;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">SYARAT TO</span></span></td></tr><tr style="height: 18px;"><td style="width: 58.4479px; height: 18px; text-align: center;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">SLOT</span></span></td><td style="width: 59.25px; height: 18px; text-align: center;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">IDR 100.000.-</span></span></td><td style="width: 71.6562px; height: 18px; text-align: center;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">IDR 1.000.000.-</span></span></td><td style="width: 57.6458px; height: 18px; text-align: center;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">22X TO</span></span></td></tr></tbody></table><p style="margin-right: 0px; margin-bottom: 10px; margin-left: 0px; color: rgb(133, 133, 133);"><span style="color: rgb(255, 0, 0);">Deposit Pertama : IDR 100.000</span></p><p style="margin-right: 0px; margin-bottom: 10px; margin-left: 0px; color: rgb(133, 133, 133);"><span style="color: rgb(255, 0, 0);">Turnover Klaim Bonus : 22x</span></p><p style="margin-right: 0px; margin-bottom: 10px; margin-left: 0px; color: rgb(133, 133, 133);"><span style="color: rgb(255, 0, 0);">Bonus : IDR 100.000 x 200% = IDR 200.000</span></p><p style="margin-right: 0px; margin-bottom: 10px; margin-left: 0px; color: rgb(133, 133, 133);"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;">Syarat Mendapatkan Bonus : (IDR 100.000 + IDR 200.000) x 22 TO = </span><span style="font-weight: 600;">IDR 6.600.000</span></span></p><p style="margin-right: 0px; margin-bottom: 10px; margin-left: 0px; color: rgb(133, 133, 133);"> </p></div><div style="font-family: digital_sans_ef_medium; font-size: 14px; color: rgb(85, 85, 85); text-align: justify;"><p style="margin-right: 0px; margin-bottom: 10px; margin-left: 0px; color: rgb(133, 133, 133); font-style: italic; line-height: 18px; padding-bottom: 20px;"><span style="color: rgb(255, 0, 0);"><span style="font-weight: 600;"><span style="text-decoration-line: underline;">SYARAT & KETENTUAN:</span></span></span></p></div><div><ul style="padding: 0px; margin: 10px 0px 10px 30px; list-style: square;"><li style="color: rgb(85, 85, 85); font-family: digital_sans_ef_medium; font-size: 14px;"><span style="color: rgb(255, 0, 0);">Cara Klaim Bonus : Pilih menu Klaim Bonus -> Klaim Komisi -> Klaim PROMO BONUS NEW MEMBER SLOTS 200%. Klik Tombol <span style="text-decoration-line: underline;">"<a href="https://xn--heroslot88-0m66b95q200c.com/desktop/bonus" style="color: rgb(255, 0, 0); outline-style: none; outline-width: initial; transition: all 0.3s ease 0s;">Klaim</a>"</span> tersebut untuk mendapatkan Bonus.</span></li><li style="color: rgb(85, 85, 85); font-family: digital_sans_ef_medium; font-size: 14px;"><span style="color: rgb(255, 0, 0);">Member hanya dapat menarik bonus dan kemenangan ketika syarat Turnover telah dipenuhi. <span style="text-decoration-line: underline;">Turnover hanya dihitung dari permainan SLOTS.</span></span></li><li style="color: rgb(85, 85, 85); font-family: digital_sans_ef_medium; font-size: 14px;"><span style="color: rgb(255, 0, 0);"><span style="text-decoration-line: underline;"><span style="font-weight: 600;">Bonus akan di berikan setelah syarat TurnOver Tercapai.</span></span></span></li><li style="color: rgb(85, 85, 85); font-family: digital_sans_ef_medium; font-size: 14px;"><span style="color: rgb(255, 0, 0);">Promosi ini tidak dapat digabung dengan promo Slots lainnya & <span style="text-decoration-line: underline;"><span style="font-weight: 600;">Promo Bonus Mingguan.</span></span></span></li><li style="color: rgb(85, 85, 85); font-family: digital_sans_ef_medium; font-size: 14px;"><span style="color: rgb(255, 0, 0);">Apabila ditemukan adanya indikasi kecurangan, Bonus Hunter, dan Kesamaan IP, maka diamond<span style="font-weight: 600;"> </span>berhak menarik bonus dan semua kemenangan.</span></li><li><font color="#ff0000" face="digital_sans_ef_medium"><span style="font-size: 14px;"><span style="font-weight: 600;">Zeus88 </span></span></font><font color="#ff0000" face="digital_sans_ef_medium"><span style="font-size: 14px;">berhak untuk mengubah, menolak,membatalkan atau menutup semua promosi sesuai dengan ketentuan yang berlaku tanpa ada pemberitahuan sebelumnya.</span></font></li><li style="color: rgb(85, 85, 85); font-family: digital_sans_ef_medium; font-size: 14px;"><span style="color: rgb(255, 0, 0);">Member yang mengikuti PROMO ini WAJIB menerima dan mengikuti semua peraturan dan persyaratan promosi ini. </span><span style="color: rgb(255, 0, 0);">Syarat dan ketentuan umum diamond 7<span style="font-weight: 600;"> </span>berlaku.</span></li><li style="color: rgb(85, 85, 85); font-family: digital_sans_ef_medium; font-size: 14px;"><span style="color: rgb(255, 0, 0);">Waktu akan diberikan selama 1x24 jam untuk mencoba mencapai syarat bonus, apabila sudah lewat maka bonus dinyatakan hangus.</span></li><li style="color: rgb(85, 85, 85); font-family: digital_sans_ef_medium; font-size: 14px;"><span style="color: rgb(255, 0, 0);">Promosi New Member tidak berlaku untuk provider <label for="ContentPlaceHolder1_edChkProvider_31" style="font-weight: bold; margin-bottom: 5px;">ADVANTPLAY MINI GAME, MM Tangkas, & Spribe</label></span></li></ul></div>    </div>
          </div>
          <div class="col-10">
            <img src="admin/assets/images/promosi/4729069473_8164313879_mg-exclusive-storm-hammer-mobile.gif" alt=" " class="w-100 h-auto mb-3">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <span style="font-size: 14px; font-weight: 700;"> </span>
              <button type="button" class="btn btn-danger text-dark" id="promosi_4" style="font-size: 10px;">Klik untuk info lebih lanjut</button>
            </div>
            <div id="expand_promosi_4">
              <font color="#ffe79c">&nbsp;</font>    </div>
            </div>
            <div class="col-10">
              <img src="admin/assets/images/promosi/3964608615_4166202376_pp-zeus-vs-hades-mobile.gif" alt=" " class="w-100 h-auto mb-3">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <span style="font-size: 14px; font-weight: 700;"> </span>
                <button type="button" class="btn btn-danger text-dark" id="promosi_3" style="font-size: 10px;">Klik untuk info lebih lanjut</button>
              </div>
              <div id="expand_promosi_3">
              </div>
            </div>
            <div class="col-10">
              <img src="admin/assets/images/promosi/7966096080_mg-kekayaan-kerajaan-zeus-mobile.gif" alt=" " class="w-100 h-auto mb-3">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <span style="font-size: 14px; font-weight: 700;"> </span>
                <button type="button" class="btn btn-danger text-dark" id="promosi_2" style="font-size: 10px;">Klik untuk info lebih lanjut</button>
              </div>
              <div id="expand_promosi_2">
              </div>
            </div>
          </div>    
                      ...
                      <div class="row g-2">
                        <div class="col">
                          <a href="index.php" class="d-flex flex-column align-items-center text-decoration-none">
                            ...
                            <img src="admin/assets/images/svg/home.svg" alt="Home" width="25" height="25">
                        ...
                        <div class="col">
                          <a href="promosi.php" class="d-flex flex-column align-items-center text-decoration-none">
                            ...
                            <img src="admin/assets/images/svg/promotion-active.svg" alt="Home" width="25" height="25">
