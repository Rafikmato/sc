        ...
        <div class="col-10">
          ...
          if ($level=="admin" || $level=="promotor") {
            ...
            if (isset($_GET['id']) && isset($_GET['email'])) {
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE email = '$email' AND id = '$id' AND depo_wd = 'Withdraw' ");
            ...
            <form action="function/aksi_ubah_withdraw.php" method="POST">
              ...
              <div class="form-group">
                <h4>Bank : </h4>
                <input type="text" class="form-control" name="bank" readonly="" value="<?php echo $bank ?>">
              </div>
              <br>
              <div class="form-group">
                <h4>Jumlah : </h4>
                <input type="number" class="form-control" name="jumlah" required="" value="<?php echo $jumlah ?>">
              </div>
              <br>
              <div class="form-group">
                <input type="submit" name="submit" class="btn btn-warning" style="float: right;" value="Ubah Data Withdraw">
              </div>
            </form>
            <?php
          }else{
